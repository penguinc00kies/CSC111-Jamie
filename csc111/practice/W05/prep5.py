    ...
    def items(self) -> list:
        ...
        if self._root is None:
            ...
            if self._right._root is None and self._left._root is None:
                ...
                return [].extend(self._left.items()) + [self._root]
            elif self._left._root is None:
                return [self._root] + [].extend(self._right.items())
            else:
    ...
    def smaller(self, item: Any) -> list:
        ...
        if self._root is None:
            ...
            if self._right._root is None and self._left._root is None:
                ...
                return [].extend(self._left.smaller(item)) + [self._root]
            elif self._left._root is None:
                return [self._root] + [].extend(self._right.smaller(item))
            else:
